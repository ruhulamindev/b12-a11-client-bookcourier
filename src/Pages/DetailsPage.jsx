...
const DetailsPage = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const result = await axios.get(`https://b12-a11-client-bookcourier.vercel.app/books_all/${id}`);
      return result.data;
    },
  });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.post("https://b12-a11-client-bookcourier.vercel.app/orders", orderData);
